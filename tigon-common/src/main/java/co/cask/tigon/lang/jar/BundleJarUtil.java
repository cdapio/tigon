...
public class BundleJarUtil {
   ...
   * @throws java.io.IOException if failed to load the manifest.
   */
  ...
  /**
   * Returns an {@link com.google.common.io.InputSupplier} for a given entry. This avoids unjar the whole file to
   * just get one entry. However, to get many entries, unjar would be more efficient. Also, the jar file
   * is scanned every time the {@link com.google.common.io.InputSupplier#getInput()} is invoked.
   *
   * @param jarLocation Location of the jar file.
   * @param entryName Name of the entry to fetch
   * @return An {@link com.google.common.io.InputSupplier}.
   */

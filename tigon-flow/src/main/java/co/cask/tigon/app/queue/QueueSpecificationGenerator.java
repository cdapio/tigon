 ...
 * for each {@link co.cask.tigon.api.flow.flowlet.Flowlet} and within
...
public interface QueueSpecificationGenerator {
   ...
   * @return A {@link com.google.common.collect.Table} consisting of From, To Flowlet and QueueSpecification.
   */

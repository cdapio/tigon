...
public interface QueueEvictor {
   ...
   * @return A {@link com.google.common.util.concurrent.ListenableFuture} that will be completed when eviction is done.
   * The future result carries number of entries being evicted.
   */

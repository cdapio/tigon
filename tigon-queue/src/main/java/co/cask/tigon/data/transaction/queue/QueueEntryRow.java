...
public class QueueEntryRow {
  ...
  /**
   * Returns {@code true} if the given {@link org.apache.hadoop.hbase.KeyValue} is a state column in queue entry row.
   */
  ...
  /**
   * Returns {@code true} if the given qualifier buffer is a state column qualifier in queue entry row.
   */
  ...
  /**
   * Returns {@code true} if the given {@link org.apache.hadoop.hbase.KeyValue} is a meta column in queue entry row.
   */
  ...
  /**
   * Returns {@code true} if the given qualifier buffer is a meta column qualifier in queue entry row.
   */
  ...
  /**
   * Returns {@code true} if the given {@link org.apache.hadoop.hbase.KeyValue} is a data column in queue entry row.
   */
  ...
  /**
   * Returns {@code true} if the given qualifier buffer is a data column qualifier in queue entry row.
   */
   ...
   * "yes" ({@link co.cask.tigon.data.transaction.queue.QueueEntryRow.CanConsume#YES},
   * "no"  ({@link co.cask.tigon.data.transaction.queue.QueueEntryRow.CanConsume#NO},
   * "no" with a hint that given consumer cannot consume any of the entries prior to this one
   *       ({@link co.cask.tigon.data.transaction.queue.QueueEntryRow.CanConsume#NO_INCLUDING_ALL_OLDER}.
   ...
   * @return one {@link co.cask.tigon.data.transaction.queue.QueueEntryRow.CanConsume} as per description above.
   */

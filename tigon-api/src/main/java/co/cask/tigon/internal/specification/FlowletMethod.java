...
/**
 * Class representing either a {@link co.cask.tigon.api.annotation.ProcessInput}
 * or {@link co.cask.tigon.api.annotation.Tick} method. Comparing is done with method name

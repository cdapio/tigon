...
public final class Schema {
  ...
  /**
   * @return An immutable {@link java.util.Set} of enum values or {@code null} if this is
   * not a {@link Type#ENUM ENUM} schema. The {@link java.util.Set#iterator()} order would be the enum values orders.
   */
  ...
  /**
   * @return An immutable {@link java.util.List} of record {@link Field Fields}
   * if this is a {@link Type#RECORD RECORD} schema or {@code null} otherwise.
   */

...
#
# Tigon documentation build configuration file
#
...
html_theme_options = {
  "versions":"http://docs.cask.co/tigon/json-versions.js",
  "versions_data":
    { "development": [
        ['0.3.0', '0.3.0'], 
        ], 
      "current": ['0.2.1', '0.2.1', '2014-10-30'], 
      "older": [ 
        ['0.2.0', '0.2.0', '2014-10-14'], 
        ['0.1.0', '0.1.0', '2014-09-25'],
        ],
    },
}
...
latex_documents = [
  ('index', 'Tigon.tex', u'Tigon Documentation',
...
man_pages = [
    ('index', 'tigon', u'Tigon Documentation',
     [u'Cask Data, Inc.'], 1)
]
...
pdf_documents = [
    ('index', u'Tigon', u'Tigon', u'Cask Data, Inc.'),
]

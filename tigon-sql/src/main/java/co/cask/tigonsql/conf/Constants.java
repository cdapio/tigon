...
public final class Constants {
  ...
  /**
   * The SQL Compiler processes ping frequency is 1 ping per second. Hence choosing 2 seconds to avoid boundary failure
   */
   ...
   * {@link co.cask.tigonsql.manager.DiscoveryServer} REST end-points to announce themselves
   */
  ...
  /**
   * File names of files parsed by {@link co.cask.tigonsql.util.MetaInformationParser}
   */

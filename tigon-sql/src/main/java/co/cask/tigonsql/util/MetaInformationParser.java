...
public class MetaInformationParser {
  ...
  /**
   * This function generates the {@link co.cask.tigonsql.api.StreamSchema} for each query specified by the user
   * @param fileLocation Directory that contains the qtree.xml file & the output_spec.cfg
   * @return A map of query names and the associated {@link co.cask.tigonsql.api.StreamSchema}
   * @throws IOException
   */

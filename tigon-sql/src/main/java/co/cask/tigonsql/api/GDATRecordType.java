...
public enum GDATRecordType {
  ...
  /**
   * Return the Record Marker Byte value for the {@link co.cask.tigonsql.api.GDATRecordType}.
  ...
  /**
   * Return the {@link co.cask.tigonsql.api.GDATRecordType} given a Record Marker Byte.
   * @param recordMarker Record Marker Byte
   * @return {@link co.cask.tigonsql.api.GDATRecordType}
   */

...
import co.cask.tigonsql.internal.StreamInputHeader;
import co.cask.tigonsql.util.GDATFormatUtil;
 ...
 * for the given input stream (the stream has a fixed {@link co.cask.tigonsql.api.StreamSchema}).
 *

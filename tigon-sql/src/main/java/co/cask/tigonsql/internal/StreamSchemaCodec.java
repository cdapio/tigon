...
/**
 * Create Schema String from {@link co.cask.tigonsql.api.StreamSchema} and vice versa.
 */
public class StreamSchemaCodec {
  ...
  /**
   * Generate {@link co.cask.tigonsql.api.StreamSchema} from serialized Schema String.
   */
